...
*Source: <https://abp.sgit.ai/articles/thirteen-prompts-and-the-fourth-page/index.html> · site v0.7.0 · this file is generated from the same content
...
> **This is the article for release v0.6.0, published 21 September 2026.** Every release of this site gets one, and it explains what that release changed and why rather than restating [v0.6.0's own release record](../../versions/v0.6.0/index.md). It is release 10 of 10 on this site, and the most recent. Every screenshot below was captured from a checkout of the `v0.6.0` tag, so it shows the site as it stood at that release and not as it stands today. Nothing follows it yet, or back to [v0.5.0](../../articles/one-article-per-release/index.md).
