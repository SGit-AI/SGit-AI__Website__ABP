...
**from** A review produced by ChatGPT at the project lead's request, on the Fractal Semantic Graphs page at sgit.ai and its supporting vaults, and handed to this site for the record
**to** Whoever builds the universes on this site, and whoever writes the next brief that claims novelty for any of it
...
The review is about the Fractal Semantic Graphs claim as a whole, which is graphs.sgit.ai's to answer. Four of its points land on this site's own map, at [/model/universes/](/model/universes/index.html), and each is taken.
