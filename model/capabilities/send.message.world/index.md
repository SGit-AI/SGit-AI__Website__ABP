...
*Source: <https://abp.sgit.ai/model/capabilities/send.message.world/index.html> · site v0.2.0 · this file is generated from the same content
...
**Send a message to anyone.** Verb `send`, object `message`, reach `world`, family `communication`. Its effect is **no**: cannot be undone.
