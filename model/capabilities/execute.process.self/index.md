...
*Source: <https://abp.sgit.ai/model/capabilities/execute.process.self/index.html> · site v0.1.0 · this file is generated from the same content
...
**Run programs inside its own sandbox only.** Verb `execute`, object `process`, reach `self`, family `process`. Its effect is **yes**: undone.
