...
*Source: <https://abp.sgit.ai/model/schema/index.html> · site v0.7.0 · this file is generated from the same content
...
> **A consumer pins a version.** Anything that computes from these files states which version it computed against. This is `v0.7.0`, content hash `sha256:d6d4ba40f1fb1f93f66`. A clone that floats against the latest has no reproducible output.
