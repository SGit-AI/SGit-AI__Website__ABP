...
*Source: <https://abp.sgit.ai/model/schema/index.html> · site v0.4.2 · this file is generated from the same content
...
| [`/data/profiles/index.json`](../../data/profiles/index.json) | `abp/profiles-index/v1` | The 9 deployment shapes. A shape is a product in a setting, not a product. |
| [`/data/mandates/index.json`](../../data/mandates/index.json) | `abp/mandates-index/v1` | The 8 starting mandates, one per surface. |
...
> **A consumer pins a version.** Anything that computes from these files states which version it computed against. This is `v0.4.2`, content hash `sha256:d6d4ba40f1fb1f93f66`. A clone that floats against the latest has no reproducible output.
