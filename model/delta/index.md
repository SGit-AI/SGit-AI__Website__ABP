...
*Source: <https://abp.sgit.ai/model/delta/index.html> · site v0.4.2 · this file is generated from the same content
...
**9 stored deltas**, one per deployment shape and mandate pair: [`/data/deltas/index.json`](../../data/deltas/index.json).
