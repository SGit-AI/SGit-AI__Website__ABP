...
*Source: <https://abp.sgit.ai/cases/beta-001/chatgpt-calendar/index.html> · site v0.7.1 · this file is generated from the same content
...
**The clauses: Rules for Google Calendar.** Paste at the top of any conversation where the assistant has this connector. Edit first: the lines you change are the ones that were actually yours.
